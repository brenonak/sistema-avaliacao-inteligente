    ...
    const fetchLista = async () => {
      try {
        ...
        if (respostasRes.ok) {
          ...
          // Se já está finalizado, redireciona para a página de resultado
          if (respostasData.finalizado) {
            router.push(`/aluno/cursos/${cursoId}/listas/${listaId}/resultado`);
            return;
          }
        }
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', p: 3 }}>
        <Paper sx={{ p: 4, textAlign: 'center', maxWidth: 500 }}>
          ...
          <Typography variant="body1" sx={{ color: 'text.secondary', mb: 3 }}>
            Suas respostas foram finalizadas com sucesso. Você será redirecionado para visualizar o resultado...
          </Typography>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="confirm-submit-description">
            ...
            <br />
            <br />
            Após a confirmação, você será redirecionado para a página de resultado onde poderá revisar suas respostas e ver sua nota, mas não poderá editá-las.
            <br />
            <br />
